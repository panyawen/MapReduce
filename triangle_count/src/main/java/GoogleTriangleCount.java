...
public class GoogleTriangleCount {
    ...
    public static class GoogleTriangleCountPartitioner extends HashPartitioner<Text, Text> {
    ...
    public static void main(String args[]){
        try {
            ...
            job.setPartitionerClass(GoogleTriangleCountPartitioner.class);
